...
public class Ambient_Interface extends JFrame implements ActionListener{
		...
		private void draw_line(Graphics g) {
		    ...
		    super.paint(g);  
                    ...
                    Line2D lin = new Line2D.Float(100, 100, 450, 300);
                    g2.draw(lin);
		...
		public void actionPerformed(ActionEvent e) {
		    ...
		    if(e.getSource() == btnSave)
		    {
				...
				Date from_time_new = null;
				Date to_time_new = null;
				...
				JOptionPane.showMessageDialog(null, "Lunch Time...!!!", "", JOptionPane.ERROR_MESSAGE);
				
				
				
				
				//System.out.println("total to time:" + to_time_new );
